...
- **تایپ کلمه به کلمه** — مثل ChatGPT
- **آپلود فایل** — عکس، داکیومنت، کد با پیش‌نمایش
- **ابزار کامل** — ترمینال، فایل، جستجو (با Hermes)
...
- **کشیدن و رها کردن** — فایل رو هرجا رها کن
...
ساخته شده توسط [SINA pk](https://github.com/sinapkn)
