...
A ChatGPT-style web interface for [Hermes Agent](https://hermes-agent.nousresearch.com). Works with or without Hermes — falls back to direct API chat when Hermes CLI isn't installed.
...
- 🔄 **Session persistence** — powered by Hermes state.db or in-memory
